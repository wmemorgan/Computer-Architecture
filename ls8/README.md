...
| Filename | Description                              | Implemented       | Not Implemented                      |
| -------- | ---------------------------------------- | ----------------- | ------------------------------------ |
| cpu.py   | A class that emulates CPU functionality. | load, alu, trace, | constructor (memory, registers), run |
| ls8.py   | Program that runs the LS-8 computer      |                   |                                      |
